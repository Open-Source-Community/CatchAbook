            ...
            <div class="col-md-4 profile-badge">
                <div class="panel">
                    ...
                    <div class="profile-pic">
                        <img src="http://susicastle.com/wp-content/uploads/2014/09/yokoyama.png"
                    ...
                    <div class="card-body">
                        <div class="card-body text-light">
                            <a href="#"><i class="fa fa-map-marker"></i> Went To<span
                                        style="color:orange"> Holanda</span> </a>
                            <a href="#"><i class="fa fa-briefcase"></i> Worked at <span
                                        style="color:orange"> Booking</span> </a>
                            <a href="#"><i class="fa fa-home "></i> Lives in <span
                                        style="color:orange"> Cairo</span></a>
                        ...
                        <div class="follow">
                            <div>
                                <a href="{{ url('/borrow') }}">
                                    <button class="btn btn-primary add" style=" font-size: 15px;margin-bottom: 5px;">
                                        Borrow
                                    </button>
                                </a>
                                <a href="{{ url('/myborrow') }}">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ url("addcomment/$user->id")}}" style="width: 90%">
                            ...
                            <input type="text" id="comment" name="comment"
                                   style="padding: 10px; border: 1px solid #f90;font-size: 14px; border-radius: 5px; width: 90%"
                                   placeholder="Please Add Your Comment Here" required>
                            <button class="btn btn-info btn btn-dark form-control add" type="submit"
                                    style="font-size: 15px; text-align: center;margin-top: 5px; width: 90%">
            ...
            <div class="col-md-8 Home">
                @foreach($books as $book)
                    <div class="card" style="width: 26rem; border-radius: 5%;">
                        <img class="card-img-top" style="height: 160px;padding: 5px;border-radius: 15px;"
                             src="{{$book->photo}}">
                        <div class="card-body">
